...
SENDGRID_API_KEY = config('EMAIL_HOST_PASSWORD', default = '')  # Your SendGrid API key
...
FRONT_END_SUCCESS_URL= config('FRONT_END_SUCCESS_URL' , default = '')
FRONT_END_FAILIURE_URL = config('FRONT_END_FAILIURE_URL' , default = '')
FRONT_END_URL = config('FRONT_END_URL' , default = '')
