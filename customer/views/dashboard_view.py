...
def get_meet_details_with_meet_id(request):
    ...
    try:
        ...
        if is_customer_1:
            date_time =convert_utc_to_local_return_dt(appointment.start_time, tracker.customer_1.time_zone)
            data = {
            ...
            date_time =convert_utc_to_local_return_dt(appointment.start_time, tracker.customer_2.time_zone)
            data = {
                "doctor_name" : f"{doctor.salutation} {doctor.first_name}",
                "specialization" : appointment.specialization.specialization,
                "time" : date_time.time(),
...
#                 appointment.start_time, "Asia/"
#             )
#         else:
#             date_time = convert_local_dt_to_utc_return_dt(
#                 # appointment.start_time, tracker.customer_2.time_zone
#                 appointment.start_time, "Asia/Culcutta"
#             )
